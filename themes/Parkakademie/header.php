...
<html <?php language_attributes();?>>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light">
      ...
      <div class="head text-center align-middle">
